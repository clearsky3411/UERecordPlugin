...
namespace
{
	FSoftObjectPath GVdjmRecordEnvConfigureAssetPath(
		TEXT("/Script/VdjmRecorder.VdjmRecordEnvDataAsset'/Game/Temp/VdjmTestDataAsset.VdjmTestDataAsset'"));
}
...
UVdjmRecordEnvDataAsset* AVdjmRecordBridgeActor::TryGetRecordEnvConfigure()
{
	 ...
	 */
	return FVdjmFunctionLibraryHelper::TryGetRecordConfigureDataAsset<UVdjmRecordEnvDataAsset>(GVdjmRecordEnvConfigureAssetPath);
}

void AVdjmRecordBridgeActor::SetRecordEnvConfigureAssetPath(const FSoftObjectPath& InAssetPath)
{
	if (!InAssetPath.IsValid())
	{
		UE_LOG(LogVdjmRecorderCore, Warning, TEXT("SetRecordEnvConfigureAssetPath - Invalid asset path: %s"), *InAssetPath.ToString());
		return;
	}

	GVdjmRecordEnvConfigureAssetPath = InAssetPath;
}

FSoftObjectPath AVdjmRecordBridgeActor::GetRecordEnvConfigureAssetPath()
{
	return GVdjmRecordEnvConfigureAssetPath;
}

void AVdjmRecordBridgeActor::ResetRecordEnvConfigureAssetPath()
{
	GVdjmRecordEnvConfigureAssetPath = FSoftObjectPath(
		TEXT("/Script/VdjmRecorder.VdjmRecordEnvDataAsset'/Game/Temp/VdjmTestDataAsset.VdjmTestDataAsset'"));
}
