...
public:
	...
	static void SetRecordEnvConfigureAssetPath(const FSoftObjectPath& InAssetPath);
	static FSoftObjectPath GetRecordEnvConfigureAssetPath();
	static void ResetRecordEnvConfigureAssetPath();
